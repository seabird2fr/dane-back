...
class AnswerHistory
{
    ...
    public function getJustifyReponse(): ?string
    {
        return $this->justify_reponse;
    }

    public function setJustifyReponse(?string $justify_reponse): self
    {
        $this->justify_reponse = $justify_reponse;
