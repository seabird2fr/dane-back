 ...
 */
final class Version20190429115205 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tbl_history_answer (id INT AUTO_INCREMENT NOT NULL, question_history_id INT NOT NULL, answer_id INT NOT NULL, answer_text LONGTEXT NOT NULL, answer_correct TINYINT(1) NOT NULL, correct_given TINYINT(1) NOT NULL, answer_succes TINYINT(1) NOT NULL, justify_reponse LONGTEXT DEFAULT NULL, INDEX IDX_9E994D3B79D11BDA (question_history_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
