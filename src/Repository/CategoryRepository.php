...
// Ajout fonction seabird pour avoir le tableau des id des questions correspondant à la categorie $id
public function findIdQuestion($id){

$category = $this->findBy(array('id' => $id));
        foreach ($category as $questions) {
