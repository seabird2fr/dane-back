...
var $addAnswerButton = $('<button class="btn btn-primary mr-2" type="button"><i class="fas fa-plus"></i> Ajouter une réponse</button>');
...
function addAnswerFormDeleteLink($answerFormLi) {
    var $removeFormButton = $('<button class="btn btn-danger btn-sm mr-2" type="button"><i class="fas fa-trash-alt"></i> Effacer cette réponse</button>');
